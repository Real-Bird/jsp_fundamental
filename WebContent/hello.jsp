...
<body>
    ...
    <form name="memberForm" action="save.html" method="post">
        <div>
            ...
            <span class="error" id="errorId" style="display: none;">아이디를 잘못 입력했습니다.</span>
        </div>
        <div>
            <label for="email">이메일</label>
            <input type="email" id="email" name="email" placeholder="이메일을 입력하세요.">
            <span class="error" id="errorEmail" style="display: none;">이메일을 잘못 입력했습니다.</span>
        </div>
        <div>
            <label for="pwd">패스워드</label>
            <input type="password" id="pwd" name="pwd" placeholder="패스워드를 입력하세요.">
            <span class="error" id="errorPwd" style="display: none;">패스워드를 잘못 입력했습니다.</span>
        </div>
        <div>
