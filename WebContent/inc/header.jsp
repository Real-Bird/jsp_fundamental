	...
	<nav class="navbar navbar-expand-md navbar-dark"
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item <%if(path != null && path.startsWith("/index.jsp")){ %>active<%}%>"><a class="nav-link"
					href="/index.jsp">홈 <span class="sr-only">(current)</span>
				</a></li>
				<li class="nav-item <%if(path != null && path.startsWith("/notice")){ %>active<%}%>"><a class="nav-link"
