        ...
        <table class="tbl type8 mt20"> 
         ...
         <tbody> 
          ...
          <tr> 
           ...
           <td class="ac"><label for="btn11"> <input type="button" name="btn11" id="btn11" value="선택 취소" onclick="test11();"></label></td> 
          </tr> 
          <tr> 
           ...
           <td class="ac"><label for="btn12"> <input type="button" name="btn12" id="btn12" value="선택 취소" onclick="test12();"></label></td> 
          </tr> 
          <tr> 
           ...
           <td class="ac"><label for="btn12"> <input type="button" name="btn12" id="btn12" value="선택 취소" onclick="test13();"></label></td>  
          </tr> 
          <tr> 
           ...
           <td class="ac"><label for="btn14"> <input type="button" name="btn14" id="btn14" value="선택 취소" onclick="test14();"></label></td>  
           </tr> 
           <tr> 
           ...
           <td class="ac"><label for="btn15"> <input type="button" name="btn15" id="btn15" value="선택 취소" onclick="test15();"></label></td>  
           </tr> 
           <tr> 
           ...
           <td class="ac"><label for="btn16"> <input type="button" name="btn16" id="btn16" value="선택 취소" onclick="test16();"></label></td>  
          </tr>
          <tr> 
           ...
           <td class="ac"><label for="btn17"> <input type="button" name="btn17" id="btn17" value="선택 취소" onclick="test17();"></label></td>  
          </tr>
          <tr> 
           ...
           <td class="ac"><label for="btn18"> <input type="button" name="btn18" id="btn18" value="선택 취소" onclick="test18();"></label></td>  
          </tr>
          <tr> 
           ...
           <td class="ac"><label for="btn19"> <input type="button" name="btn19" id="btn19" value="선택 취소" onclick="test19();"></label></td>  
          </tr>
          <tr> 
            <td>20. 매사가 엉망이었다.</td> 
           ...
           <td class="ac"><label for="btn20"> <input type="button" name="btn20" id="btn20" value="선택 취소" onclick="test20();"></label></td>  
          </tr>
          <tr> 
		    ...
		    <td class="ac"><label for="btn21"> <input type="button" name="btn21" id="btn21" value="선택 취소" onclick="test21();"></label></td> 
		   </tr> 
		   <tr> 
		    ...
		    <td class="ac"><label for="btn22"> <input type="button" name="btn22" id="btn22" value="선택 취소" onclick="test22();"></label></td> 
		   </tr> 
		   <tr> 
		    ...
		    <td class="ac"><label for="btn22"> <input type="button" name="btn22" id="btn22" value="선택 취소" onclick="test23();"></label></td>  
		   </tr> 
		   <tr> 
		    ...
		    <td class="ac"><label for="btn24"> <input type="button" name="btn24" id="btn24" value="선택 취소" onclick="test24();"></label></td>  
		    </tr> 
		    <tr> 
		    ...
		    <td class="ac"><label for="btn25"> <input type="button" name="btn25" id="btn25" value="선택 취소" onclick="test25();"></label></td>  
		    </tr> 
		    <tr> 
		    ...
		    <td class="ac"><label for="btn26"> <input type="button" name="btn26" id="btn26" value="선택 취소" onclick="test26();"></label></td>  
		   </tr>
		   <tr> 
		    ...
		    <td class="ac"><label for="btn27"> <input type="button" name="btn27" id="btn27" value="선택 취소" onclick="test27();"></label></td>  
		   </tr>
		   <tr> 
		    ...
		    <td class="ac"><label for="btn28"> <input type="button" name="btn28" id="btn28" value="선택 취소" onclick="test28();"></label></td>  
		   </tr>
		   <tr> 
		    ...
		    <td class="ac"><label for="btn29"> <input type="button" name="btn29" id="btn29" value="선택 취소" onclick="test29();"></label></td>  
		   </tr>
		    <tr> 
		     ...
		     <td class="ac"><label for="btn30"> <input type="button" name="btn30" id="btn30" value="선택 취소" onclick="test30();"></label></td>  
		    </tr>
		    <tr> 
		    ...
		    <td class="ac"><label for="btn31"> <input type="button" name="btn31" id="btn31" value="선택 취소" onclick="test31();"></label></td> 
		   </tr> 
		   <tr> 
		    ...
		    <td class="ac"><label for="btn32"> <input type="button" name="btn32" id="btn32" value="선택 취소" onclick="test32();"></label></td> 
		   </tr> 
		   <tr> 
		    ...
		    <td class="ac"><label for="btn32"> <input type="button" name="btn32" id="btn32" value="선택 취소" onclick="test33();"></label></td>  
		   </tr> 
		   <tr> 
		    ...
		    <td class="ac"><label for="btn34"> <input type="button" name="btn34" id="btn34" value="선택 취소" onclick="test34();"></label></td>  
		    </tr> 
		    <tr> 
		    ...
		    <td class="ac"><label for="btn35"> <input type="button" name="btn35" id="btn35" value="선택 취소" onclick="test35();"></label></td>  
		    </tr> 
		    <tr> 
		     <td>36. 날씨가 나빴다.</td> 
		    ...
		    <td class="ac"><label for="btn36"> <input type="button" name="btn36" id="btn36" value="선택 취소" onclick="test36();"></label></td>  
		   </tr>
		   <tr> 
		     <td>37. 교통체증이 있었다.</td> 
		    ...
		    <td class="ac"><label for="btn37"> <input type="button" name="btn37" id="btn37" value="선택 취소" onclick="test37();"></label></td>  
		   </tr>
		   <tr> 
		    ...
		    <td class="ac"><label for="btn38"> <input type="button" name="btn38" id="btn38" value="선택 취소" onclick="test38();"></label></td>  
		   </tr>
		   <tr> 
		    ...
		    <td class="ac"><label for="btn39"> <input type="button" name="btn39" id="btn39" value="선택 취소" onclick="test39();"></label></td>  
		   </tr>
		   <tr> 
		     <td>40. 잠을 제대로 못잤다. </td> 
		    ...
		    <td class="ac"><label for="btn40"> <input type="button" name="btn40" id="btn40" value="선택 취소" onclick="test40();"></label></td>  
		   </tr>
		               <tr> 
            ...
            <td class="ac"><label for="btn41"> <input type="button" name="btn41" id="btn41" value="선택 취소" onclick="test41();"></label></td> 
            </tr> 
            <tr> 
            ...
            <td class="ac"><label for="btn42"> <input type="button" name="btn42" id="btn42" value="선택 취소" onclick="test42();"></label></td> 
            </tr> 
            <tr> 
            ...
            <td class="ac"><label for="btn42"> <input type="button" name="btn42" id="btn42" value="선택 취소" onclick="test43();"></label></td>  
            </tr> 
            <tr> 
            ...
            <td class="ac"><label for="btn44"> <input type="button" name="btn44" id="btn44" value="선택 취소" onclick="test44();"></label></td>  
            </tr> 
            <tr> 
                <td>45. 오해를 받았다.</td> 
            ...
            <td class="ac"><label for="btn45"> <input type="button" name="btn45" id="btn45" value="선택 취소" onclick="test45();"></label></td>  
            </tr> 
            <tr> 
            ...
            <td class="ac"><label for="btn46"> <input type="button" name="btn46" id="btn46" value="선택 취소" onclick="test46();"></label></td>  
            </tr>
            <tr> 
            ...
            <td class="ac"><label for="btn47"> <input type="button" name="btn47" id="btn47" value="선택 취소" onclick="test47();"></label></td>  
            </tr>
            <tr> 
            ...
            <td class="ac"><label for="btn48"> <input type="button" name="btn48" id="btn48" value="선택 취소" onclick="test48();"></label></td>  
            </tr>
            <tr> 
            ...
            <td class="ac"><label for="btn49"> <input type="button" name="btn49" id="btn49" value="선택 취소" onclick="test49();"></label></td>  
            </tr>
          <tr> 
           ...
           <td class="ac"><label for="btn50"> <input type="button" name="btn50" id="btn50" value="선택 취소" onclick="test50();"></label></td>  
          </tr>
                      <tr> 
            ...
            <td class="ac"><label for="btn51"> <input type="button" name="btn51" id="btn51" value="선택 취소" onclick="test51();"></label></td> 
            </tr> 
            <tr> 
            <td>52. 누군가와 경쟁하였다.</td> 
            ...
            <td class="ac"><label for="btn52"> <input type="button" name="btn52" id="btn52" value="선택 취소" onclick="test52();"></label></td> 
            </tr> 
            <tr> 
            ...
            <td class="ac"><label for="btn52"> <input type="button" name="btn52" id="btn52" value="선택 취소" onclick="test53();"></label></td>  
            </tr> 
            <tr> 
            ...
            <td class="ac"><label for="btn54"> <input type="button" name="btn54" id="btn54" value="선택 취소" onclick="test54();"></label></td>  
            </tr> 
            <tr> 
            ...
            <td class="ac"><label for="btn55"> <input type="button" name="btn55" id="btn55" value="선택 취소" onclick="test55();"></label></td>  
            </tr> 
            <tr> 
            ...
            <td class="ac"><label for="btn56"> <input type="button" name="btn56" id="btn56" value="선택 취소" onclick="test56();"></label></td>  
            </tr>
            <tr> 
            ...
            <td class="ac"><label for="btn57"> <input type="button" name="btn57" id="btn57" value="선택 취소" onclick="test57();"></label></td>  
            </tr>
            <tr> 
            ...
            <td class="ac"><label for="btn58"> <input type="button" name="btn58" id="btn58" value="선택 취소" onclick="test58();"></label></td>  
            </tr>
         </tbody> 
        </table> 
        <div class="ac mt20">
