	...
	<div class="row">
		...
		<h4>공지사항 수정</h4>
			...
			<form name="noticeForm" method="post" action="modifyDb.jsp">
				<div class="form-group">
					<label for="writer">작성자</label> <input type="text"
						...
						value= "<%=dto.getWriter() %>" placeholder="작성자를 입력하세요">
				</div>
				<div class="form-group">
					<label for="title">제목</label> <input type="text"
						class="form-control" id="title" name="title"
						value= "<%=dto.getTitle() %>" placeholder="제목을 입력하세요">
				</div>
				<div class="form-group">
			...
			<div class="text-right">
				<a class="btn btn-light" href="view.jsp?num=<%= num%>&page=<%= cPage%>" role="button">뷰</a> 
