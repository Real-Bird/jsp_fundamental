        ...
        <table class="tbl type8 mt20"> 
         ...
         <tbody> 
          <tr> 
           ...
           <td class="ac"><label for="env_1_awfully"> <input type="radio" name="env_1" id="env_1_awfully" value="6" title="굉장히 많이 받았다" checked="checked"></label></td> 
           <td class="ac"><label for="env_1_infinitely"> <input type="radio" name="env_1" id="env_1_infinitely" value="7" title="극도로 받았다"></label></td> 
           <td class="ac"><label for="env_1_none"><input type="radio" name="env_1" id="env_1_none" value="0" title="해당사항 없음" ></label></td>
          </tr> 
          <tr> 
...
<script>
	console.log(document.getElementById('env_1_awfully').value);
	</script>
